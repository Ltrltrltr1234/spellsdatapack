...
execute store result entity @s Motion[0] double 0.2 run scoreboard players operation @s motion_x2 -= @s motion_x1
execute store result entity @s Motion[1] double 0.03 run scoreboard players operation @s motion_y2 -= @s motion_y1
execute store result entity @s Motion[2] double 0.2 run scoreboard players operation @s motion_z2 -= @s motion_z1
