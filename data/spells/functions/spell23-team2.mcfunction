...
execute as @s[scores={mana=150..,rightclick=1..},tag=spell23beam] at @s run summon armor_stand ^ ^ ^1 {Team:"team2",NoGravity:1b,Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["projectile15"],DisabledSlots:4144959}
...
execute as @s[scores={mana=150..,rightclick=1..},tag=spell23projectiles] at @s run summon armor_stand ^-0.5 ^1 ^1 {Team:"team2",Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["projectile16"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:sea_lantern",Count:1b,tag:{Enchantments:[{}]}}]}
execute as @s[scores={mana=150..,rightclick=1..},tag=spell23projectiles] at @s run summon armor_stand ^ ^1 ^1 {Team:"team2",Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["projectile16"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:sea_lantern",Count:1b,tag:{Enchantments:[{}]}}]}
execute as @s[scores={mana=150..,rightclick=1..},tag=spell23projectiles] at @s run summon armor_stand ^0.5 ^1 ^1 {Team:"team2",Silent:1b,Invulnerable:1b,Invisible:1b,Tags:["projectile16"],DisabledSlots:4144959,ArmorItems:[{},{},{},{id:"minecraft:sea_lantern",Count:1b,tag:{Enchantments:[{}]}}]}
