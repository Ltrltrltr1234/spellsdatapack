...
execute as @s[scores={rightclick=1..}] at @s run tag @e[tag=projectile18,team=team2,distance=..5] add boosted
execute as @s[scores={rightclick=1..}] at @s run execute as @e[type=armor_stand,distance=..5,team=!team1,tag=!nullshockimmune] at @s run playsound item.shield.block master @a ~ ~ ~ 1 0.5
execute as @s[scores={rightclick=1..}] at @s run execute as @e[type=armor_stand,distance=..5,team=!team1,tag=!nullshockimmune] at @s run playsound block.fire.extinguish master @a ~ ~ ~ 2 2
execute as @s[scores={rightclick=1..}] at @s run execute as @e[type=armor_stand,distance=..5,team=!team1,tag=!nullshockimmune] at @s run particle cloud ~ ~ ~ 0 0 0 0.1 40 normal @a
execute as @s[scores={rightclick=1..}] at @s run execute as @e[type=armor_stand,distance=..5,team=!team1,tag=!nullshockimmune] at @s run kill @s
execute as @s[scores={rightclick=1..}] at @s run execute as @e[distance=..5,team=!team1] at @s run scoreboard players set @s spell24kbtargettimer 20
