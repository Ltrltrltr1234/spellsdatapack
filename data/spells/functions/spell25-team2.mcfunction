...
execute as @s[scores={mana=70..,focus=3}] at @s positioned as @s if score >>beamdmg beamdelay matches 1..1 run summon armor_stand ^ ^ ^1 {Team:"team2",NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["projectile17"],DisabledSlots:4144959}
