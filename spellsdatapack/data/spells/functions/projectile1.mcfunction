...
execute as @e[tag=projectile1] at @s positioned as @s unless block ^ ^ ^1 air run summon creeper ^ ^ ^2 {CustomName:'{"text":"Blazing Fireball","color":"gold","bold":true}',Team:"team1",Silent:1b,Invulnerable:1b,PersistenceRequired:1b,NoAI:1b,ExplosionRadius:1b,Fuse:0,ignited:1b}
