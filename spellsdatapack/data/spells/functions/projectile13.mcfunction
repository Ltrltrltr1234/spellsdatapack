execute as @e[tag=projectile13,team=team1] at @s run tp @s ~ ~ ~ facing entity @e[type=!armor_stand,limit=1,sort=nearest,team=!team1,distance=..8]
execute as @e[tag=projectile13,team=team2] at @s run tp @s ~ ~ ~ facing entity @e[type=!armor_stand,limit=1,sort=nearest,team=!team2,distance=..8]
...
execute as @e[tag=projectile13,tag=projdeadlol,team=team1] at @s at @e[distance=..2,team=!team1,limit=1,sort=nearest] run summon arrow ~ ~ ~ {CustomName:'{"text":"Wind Blast","color":"#E3E3E3","bold":true}',pickup:0b,damage:2d,Tags:["damager1"],SoundEvent:"block.wool.place"}
execute as @e[tag=projectile13,tag=projdeadlol,team=team2] at @s at @e[distance=..2,team=!team2,limit=1,sort=nearest] run summon arrow ~ ~ ~ {CustomName:'{"text":"Wind Blast","color":"#E3E3E3","bold":true}',pickup:0b,damage:2d,Tags:["damager2"],SoundEvent:"block.wool.place"}
