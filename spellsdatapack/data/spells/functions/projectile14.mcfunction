execute as @e[tag=projectile14,scores={spell21delay=5..},team=team1] at @s run summon armor_stand ^ ^ ^ {Team:"team1",NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["thornlash"],DisabledSlots:4144959}
execute as @e[tag=projectile14,scores={spell21delay=5..},team=team2] at @s run summon armor_stand ^ ^ ^ {Team:"team2",NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["thornlash"],DisabledSlots:4144959}
execute as @e[tag=projectile14,scores={spell21delay=5..}] run scoreboard players set @s spell21delay 0
execute as @e[tag=projectile14] run scoreboard players add @s spell21delay 1
execute as @e[tag=projectile14,tag=!projdead] at @s run tp @s ^ ^ ^0.8
...
execute as @e[tag=projectile14,tag=projdead] at @s run playsound block.fire.extinguish master @a ~ ~ ~ 0.5 1 0
...
execute as @e[tag=projectile14,tag=projdead,team=team1] at @s run execute as @a[limit=1,sort=nearest,team=team1,tag=thornlashcasted] at @s if block ^ ^2 ^1 air run tp @s ^ ^0.5 ^0.5 facing entity @e[limit=1,sort=nearest,tag=thornlash,team=team1]
...
execute as @e[tag=projectile14,tag=projdead,team=team2] at @s run execute as @a[limit=1,sort=nearest,team=team2,tag=thornlashcasted] at @s if block ^ ^2 ^1 air run tp @s ^ ^0.5 ^0.5 facing entity @e[limit=1,sort=nearest,tag=thornlash,team=team2]
...
execute as @e[tag=projectile14] if score @s projtime matches 200.. run kill @s
...
execute as @e[tag=thornlash,tag=!projectile14] if score @s projtime matches 200.. run kill @s