...
execute as @e[tag=projectile5] at @s run particle totem_of_undying ~ ~ ~ 0.1 0.1 0.1 0 5 normal @a
...
execute as @e[tag=projectile5,team=team1,tag=projectiledead] at @s positioned ^ ^ ^1 run effect give @e[distance=..2,team=!team1] poison 6 3 true
execute as @e[tag=projectile5,team=team2,tag=projectiledead] at @s positioned ^ ^ ^1 run effect give @e[distance=..2,team=!team2] poison 6 3 true
