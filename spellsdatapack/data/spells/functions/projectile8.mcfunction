execute as @e[tag=projectile8,team=team1] at @s run tp @s ~ ~ ~ facing entity @e[limit=1,sort=nearest,team=!team1,distance=..20]
execute as @e[tag=projectile8,team=team2] at @s run tp @s ~ ~ ~ facing entity @e[limit=1,sort=nearest,team=!team2,distance=..20]
