execute as @e[tag=projectile8,team=team1] at @s run tp @s ~ ~ ~ facing entity @e[type=!armor_stand,limit=1,sort=nearest,team=!team1,distance=..20]
execute as @e[tag=projectile8,team=team2] at @s run tp @s ~ ~ ~ facing entity @e[type=!armor_stand,limit=1,sort=nearest,team=!team2,distance=..20]
execute as @e[tag=projectile8] at @s run tp @s ^ ^ ^0.4
...
execute as @e[tag=projectile8,tag=projdeadlol,team=team1] at @s if entity @e[type=!creeper,team=!team1,distance=..3] run effect give @a[limit=1,sort=nearest,team=team1] regeneration 3 2
execute as @e[tag=projectile8,tag=projdeadlol,team=team2] at @s if entity @e[type=!creeper,team=!team2,distance=..3] run effect give @a[limit=1,sort=nearest,team=team2] regeneration 3 2
