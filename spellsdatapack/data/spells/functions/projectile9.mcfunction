...
execute as @e[tag=projectile9] at @s positioned as @s run particle dripping_water ^ ^ ^ 0.08 0.08 0.08 0 15 normal @a
execute as @e[tag=projectile9] at @s positioned as @s run particle splash ^ ^ ^ 0.2 0.2 0.2 0 5 normal @a
execute as @e[tag=projectile9] at @s positioned as @s run particle dust 0.231 0.333 1.000 1 ^ ^ ^ 0.08 0.08 0.08 0 15 normal @a
execute as @e[tag=projectile9] at @s positioned as @s unless block ^ ^ ^ air run tag @s add projdeadlol
