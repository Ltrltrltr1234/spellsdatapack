execute as @e[scores={spell13timer=1..}] at @s rotated 0 0 run particle composter ^ ^ ^3 0 2 0 0 10 normal
execute as @e[scores={spell13timer=1..}] at @s rotated 0 0 run particle composter ^ ^ ^-3 0 2 0 0 10 normal
execute as @e[scores={spell13timer=1..}] at @s rotated 0 0 run particle composter ^3 ^ ^ 0 2 0 0 10 normal
execute as @e[scores={spell13timer=1..}] at @s rotated 0 0 run particle composter ^-3 ^ ^ 0 2 0 0 10 normal
execute as @e[scores={spell13timer=1..}] at @s rotated 0 0 run particle composter ^2 ^ ^2 0 2 0 0 10 normal
execute as @e[scores={spell13timer=1..}] at @s rotated 0 0 run particle composter ^-2 ^ ^2 0 2 0 0 10 normal
execute as @e[scores={spell13timer=1..}] at @s rotated 0 0 run particle composter ^-2 ^ ^-2 0 2 0 0 10 normal
execute as @e[scores={spell13timer=1..}] at @s rotated 0 0 run particle composter ^2 ^ ^-2 0 2 0 0 10 normal
