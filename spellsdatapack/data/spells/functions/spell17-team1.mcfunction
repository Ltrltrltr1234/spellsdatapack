execute as @s[scores={mana=20..39,rightclick=1..}] at @s run summon armor_stand ^ ^ ^1 {Team:"team1",NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["projectile9"],DisabledSlots:4144959}
...
execute as @s[scores={mana=40..59,rightclick=1..}] at @s run summon armor_stand ^ ^ ^1 {Team:"team1",NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["projectile9"],DisabledSlots:4144959}
...
execute as @s[scores={mana=60..99,rightclick=1..}] at @s run summon armor_stand ^ ^ ^1 {Team:"team1",NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["projectile9"],DisabledSlots:4144959}
execute as @s[scores={mana=60..99,rightclick=1..}] at @s run summon armor_stand ^0.1 ^ ^0.9 {Team:"team1",NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["projectile9"],DisabledSlots:4144959}
execute as @s[scores={mana=60..99,rightclick=1..}] at @s run summon armor_stand ^-0.3 ^ ^0.7 {Team:"team1",NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["projectile9"],DisabledSlots:4144959}
execute as @s[scores={mana=60..99,rightclick=1..}] at @s run summon armor_stand ^-0.5 ^ ^0.5 {Team:"team1",NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["projectile9"],DisabledSlots:4144959}
execute as @s[scores={mana=60..99,rightclick=1..}] at @s run summon armor_stand ^0.5 ^ ^0.5 {Team:"team1",NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["projectile9"],DisabledSlots:4144959}
execute as @s[scores={mana=60..99,rightclick=1..}] at @s run summon armor_stand ^0.3 ^ ^0.7 {Team:"team1",NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["projectile9"],DisabledSlots:4144959}
execute as @s[scores={mana=60..99,rightclick=1..}] at @s run summon armor_stand ^-0.1 ^ ^0.9 {Team:"team1",NoGravity:1b,Silent:1b,Invulnerable:1b,Marker:1b,Invisible:1b,Tags:["projectile9"],DisabledSlots:4144959}
