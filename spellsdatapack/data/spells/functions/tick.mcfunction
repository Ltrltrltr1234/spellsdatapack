...
execute as @e[nbt={SelectedItem:{id:"minecraft:warped_fungus_on_a_stick",Count:1b,tag:{wand:1b,spell:13}}},scores={mana=150..}] run function spells:spell13
...
execute if score >>beamdmg beamdmg matches 10.. run scoreboard players set >>beamdmg beamdmg 0
